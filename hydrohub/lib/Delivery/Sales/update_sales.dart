...
class UpdateSales extends StatefulWidget {
  ...
  @override
  State<UpdateSales> createState() => _UpdateDeliverySalesState();
}

class _UpdateDeliverySalesState extends State<UpdateSales> {
  List<dynamic> sales = [];
  bool isLoading = true;
      ...
      builder: (context) {
        return StatefulBuilder(builder: (context, setStateDialog) {
          return AlertDialog(
            ...
            title: const Text("✏️ Update Delivery Sale", style: TextStyle(color: Colors.white)),
              ...
              TextButton(
                onPressed: () {
                  final updatedData = {
                    ...
                    "sale_type": "delivery", // ensure stays delivery
                  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Update Delivery Sales"),
      ),
      body: isLoading
          ? const Center(child: CircularProgressIndicator())
          : sales.isEmpty
              ? const Center(
                  child: Text("No Delivery sales available",
