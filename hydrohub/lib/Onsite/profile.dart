...
import '../../Sessions/onsite_session.dart'; // ✅ ensure this path is correct

class OnsiteProfilePage extends StatefulWidget {
  final int staffId;
  final int stationId;

  const OnsiteProfilePage({
    super.key,
  ...
  @override
  State<OnsiteProfilePage> createState() => _OnsiteProfilePageState();
}

class _OnsiteProfilePageState extends State<OnsiteProfilePage> {
  bool isLoading = true;
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              await OnsiteSession.clear(); // ✅ Clears memory + prefs
