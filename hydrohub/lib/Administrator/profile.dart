...
import '../../Sessions/admin_session.dart';
import '../Administrator/home_page.dart';
  ...
  Future<void> fetchProfile() async {
    try {
      final response = await http.get(
        Uri.parse("http://10.0.2.2:3000/api/accounts/admin/${widget.adminId}"),
      );
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const HomePage(), // your admin home
                                  ),
                                );
                              },
                            ),
